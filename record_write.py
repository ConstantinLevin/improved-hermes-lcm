...
class RecordWriteMixin:
    ...
    def _write_summary(
        ...
        *,
        ...
        effort asked for and the effort field the call carried (or why none was sent), the
        provider's ``finish_reason``, and the encrypted reasoning withheld from its input
        (#8, #9)."""
